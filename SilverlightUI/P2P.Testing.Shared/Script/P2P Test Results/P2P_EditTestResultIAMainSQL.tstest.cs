...
namespace P2P.Testing.Shared.Script
{
    ...
    public class P2PEditTestResultIAMainSQL : BaseWebAiiTest
    {
        [CodedStep("Edit SQL Test Result File for IA Main")]
        public void EditP2PTestResult()
        {
            ...
            DataRow drTestAdminSqlResults = objEdXmlReader.Read_xml_file("P2PTestResults.xml", "Test_Results", "TR_Application", "IAMainAdminSQL");

            // Read correct data row from xml file
            DataRow drTestSilverlightSqlResults = objEdXmlReader.Read_xml_file("P2PTestResults.xml", "Test_Results", "TR_Application", "IAMainSilverlightSQL");
