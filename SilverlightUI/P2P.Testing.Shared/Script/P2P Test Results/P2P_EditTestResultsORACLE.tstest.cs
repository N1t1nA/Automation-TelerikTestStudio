...
namespace P2P.Testing.Shared.Script
{
    ...
    public class P2PEditTestResultOracle : BaseWebAiiTest
    {
        [CodedStep("Edit Oracle Test Result File")]
        public void EditP2PTestResult()
        {
            ...
            DataRow drTestAdminSqlResults = objEdXmlReader.Read_xml_file("P2PTestResults.xml", "Test_Results", "TR_Application", "P2PAdminORACLE");

            // Read correct data row from xml file
            DataRow drTestSilverlightSqlResults = objEdXmlReader.Read_xml_file("P2PTestResults.xml", "Test_Results", "TR_Application", "P2PSilverlightORACLE");
